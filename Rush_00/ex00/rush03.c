...
/*   Updated: 2022/02/05 11:20:06 by yeyun            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

char	g_top_left_p = 'A', g_top_right_p = 'C';
char	g_top_bottom_line = 'B';
char	g_bottom_left_p = 'A', g_bottom_right_p = 'C';
char	g_left_right_line = 'B';
char	g_space = ' ';
